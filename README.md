...
How to use:
You will need to add API key from battlemetrics either to start.sh or your system enviromental variable.

After adding the API key use command: "./start.sh"

Features: Searching DayZ servers by name, saving them to bookmarks, saving servers to bookmarks manually, bookmark system.
